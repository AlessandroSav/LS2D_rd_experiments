...
# LS2D & custom modules
sys.path.append('/home/paaa/LS2D_rd_experiments')
sys.path.append('/perm/paaa/Les/Cases/Catrine/')
import ls2d
import dales_ls2d_tools as dlt

#
# Download IFS experiment and generate LES initialisation and forcings
#
settings = {
    'central_lat' : 51.971,
    'central_lon' : 4.927,
    'area_size'   : 1,
    'case_name'   : 'catrine_netherlnads',
    'era5_path'   : '/scratch/paaa/LS2D/',
    'start_date'  : datetime(year=2022, month=5, day=15, hour=0),
    'end_date'    : datetime(year=2022, month=5, day=20, hour=23),
    'write_log'   : True,
    'data_source' : 'CDS'
    }


# Extract Research Experiment:
ls2d.download_RDexp(settings)
# Read experiment data, and calculate derived properties (thl, etc.):
era = ls2d.Read_RDexp(settings)
...
docstring = '(LS)2D case CATRINE Netherlands: {} to {}'.format(
...
attrib = {
    ...
    'case_name'         : 'CATRINE Netherlands',
    }

les_input_eurec4a = les_input[[
        'thl',
        'qt',
        'u',
        'v',
